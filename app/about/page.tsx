    ...
    <Layout heading="A little bit about me" subheading="Who I am and what I do.">
        <div className="about">
            <div className="section left_section">
                ...
                <div className="paragraph">With one years of invaluable experience as a software developer at Arisecraft Technologies –– a tech startup company based here in Udupi, I have honed my skills in React.js, Next.js, Express.js, TypeScript, and so on... allowing me to craft seamless and interactive user experiences. During my time at Arisecraft Technologies, I had the privilege of working on projects for great clients. It was an really rewarding experience.</div>
                <div className="heading">WHAT I DID</div>
                <div className="paragraph">Before becoming a full stack developer , I have worked intensely on frontend.  developing landing pages with excellent animations and responsiveness. As a full stack developer I've developed quite a few web applications with required functionality including payment gateways. As a result, I am adept at seamlessly integrating functionality with outstanding UI, including animations, in the web applications and websites I've created.</div>
                <div className="heading"></div>
                <div className="paragraph">Feel free to reach out via <a href="" className="highlight underline">e-mail</a>, or follow me on <a href="" className="highlight underline">Twitter</a>. Want to see where I’ve worked? Check out my <a href="" className="highlight underline">Resume</a>, or Connect with me on <a href="" className="highlight underline">LinkedIn</a>.</div>    
                <div className="heading"></div>
                <div className="heading"></div>
